              ...
              <div className="panel-body">
                <form>
                  ...
                  <div className="form-group">
                    ...
                    <input type="number" value={this.state.value} className="form-control" id="term" onChange={this.handleChange} required />
                  </div>
                  <div className="form-group">
                    <label for="end"><h4 className="">End Year: </h4></label>
                    <input type="text" value={this.state.value} className="form-group" id="end" onChange={this.handleChange} required />
                 </div>
